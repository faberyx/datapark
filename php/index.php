...
$result = $dbh->query("SELECT fauna.nome as fn,fauna.specie,specie.nome as sn,specie.id FROM fauna,specie WHERE fauna.specie=specie.id ORDER BY sn");
$stmt = $dbh->query("SELECT fauna.nome as fn,fauna.specie,specie.nome as sn,specie.id FROM fauna,specie WHERE fauna.specie=specie.id ORDER BY sn");
